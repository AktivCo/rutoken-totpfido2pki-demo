...
Для сборки и запуска веб-сервиса необходим установленный в системе [.NET SDK 8](https://dotnet.microsoft.com/en-us/download/dotnet/8.0).
...
4. Скопировать сборки и файлы docker.
    ...
    scp -r RutokenTotpFido2Demo/bin/Release/net8.0/publish/* ${destinationFolder}/app
    ```
